...
var budgetController = (function() {
  // Create fist function constructure( Class ) for expense data
  ...
  // Create second function constructure( Class ) for income data
...
var UIController = (function() {
  ...
  // Create function to format the number [ex: 2554.6289 will be 2,554.63]
...
return {
    getInput: function() {
     ...
     // Create method to add new element on the UI
    ...
    cleareFields: function() {
      var fields, fieldArr;

      //select all fields we want to clean
      fields = document.querySelectorAll(DOMstrings.inputDescription + ', ' + DOMstrings.inputValue);
      //call 'slice' method from array object to use it with the list of selectors (querySelectAll return 'list' of elements not 'array' so we can't use array method directly)
    ...
    // Add Method to print data comes from  BUDGET CONTROLLER(getBudget Method)
    ...
    displayPercentage: function( percentages) {
       var fields = document.querySelectorAll(DOMstrings.expensesPercLabel);
        ...
        nodeListForEach(fields, function(cur, indx) {
